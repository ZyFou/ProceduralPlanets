...
export const PROJECT_TEMPLATES = [
  ...
  { id: 'gas-giant', name: 'Gas giant', description: 'Warm bands, storms, and a deep marbled atmosphere.', mode: 'gas', preset: 'gasGiant', kind: 'Gas' },
  { id: 'ice-giant', name: 'Ice giant', description: 'Cold blue bands and soft high-altitude storms.', mode: 'gas', preset: 'iceGiant', kind: 'Gas' },
  { id: 'sun', name: 'Sun', description: 'A bright boiling star with warm granulation.', mode: 'star', preset: 'sun', kind: 'Star' },
